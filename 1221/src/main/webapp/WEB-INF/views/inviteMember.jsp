...
<body>
	...
	<br>
	비밀번호 : <input type="password" id="password1" name="pass" placeholder="비밀번호를 입력하시오"><br>
	비밀번호확인 : <input type="password" id="password2" name="pass" placeholder="비밀번호를 입력하시오"><br>
